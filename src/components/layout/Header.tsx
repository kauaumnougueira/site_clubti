        ...
        <S.NavHeader>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center">
                    <img src={ClubTiLogo} alt="Logo" width="194" height="76" onClick={() => setPage('principal')} />
                </a>
                <button
                ...
                <S.Menu isOpen={isOpen} className={`md:block ${isOpen ? 'block' : 'hidden'}`} id="navbar-default">
                    <ul className="font-normal flex flex-col p-4 md:p-0 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
